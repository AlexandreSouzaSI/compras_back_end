...
import type { IProdutoRepository } from '../../application/reporitories/produto.repository.interface';
import { CreateProdutoDto } from '../http/dtos/produto/create-produto.dto';
import { UpdateProdutoDto } from '../http/dtos/produto/update-produto.dto';
import { ProdutoResponseDto } from '../http/dtos/produto/produto-response.dto';
